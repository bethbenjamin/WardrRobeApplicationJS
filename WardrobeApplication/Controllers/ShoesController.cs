...
namespace WardrobeApplication.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoeID,Name,Photo,Color,Season,Occasion,Type")] Shoe shoe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoeID,Name,Photo,Color,Season,Occasion,Type")] Shoe shoe)
        {
            if (ModelState.IsValid)
            {
